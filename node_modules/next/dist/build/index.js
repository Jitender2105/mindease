...
async function build(dir, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false, appDirOnly = false, isTurbopack = false, experimentalBuildMode, traceUploadUrl) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            await (0, _builddiagnostics.recordFrameworkVersion)("15.4.0-canary.15");
                                    ...
                                    if (pageType === 'app' && originalAppPath) {
                                        ...
                                        if ((0, _isedgeruntime.isEdgeRuntime)(pageRuntime)) {
                                            ...
                                            if (workerResult.isRoutePPREnabled) {
                                                ...
                                                if (// The existence of any prerendered routes when
                ...
                await staticGenerationSpan.traceAsyncFn(async ()=>{
                            ...
                            staticPaths.forEach((routes, originalAppPath)=>{
                                ...
                                routes.forEach((route)=>{
                                    ...
                                    defaultMap[route.pathname] = {
                                        ...
                                        _doNotThrowOnEmptyStaticShell: !route.throwOnEmptyStaticShell
                                    };
                                });
                            });
                    ...
                    if (config.experimental.clientSegmentCache) {
                        for (const route of [
                            ...
                            // app page.
                            const originalAppPath = (_pageInfos_get = pageInfos.get(route.page)) == null ? void 0 : _pageInfos_get.originalAppPath;
                            if (!originalAppPath) {
                                continue;
                            }
