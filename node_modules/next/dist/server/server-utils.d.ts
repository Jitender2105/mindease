...
export declare function normalizeCdnUrl(req: BaseNextRequest | IncomingMessage, paramKeys: string[], defaultRouteRegex: ReturnType<typeof getNamedRouteRegex> | undefined): void;
...
export declare function getUtils({ page, i18n, basePath, rewrites, pageIsDynamic, trailingSlash, caseSensitive, }: {
    ...
    normalizeQueryParams: (query: Record<string, string | string[] | undefined>) => void;
    ...
    normalizeCdnUrl: (req: BaseNextRequest | IncomingMessage, paramKeys: string[]) => void;
