...
async function spawnDynamicValidationInDev(resolveValidation, tree, ctx, isNotFound, clientReferenceManifest, route, requestStore) {
    ...
    try {
        const prerender = require('react-dom/static.edge').prerender;
        const { prelude: unprocessedPrelude } = await (0, _apprenderprerenderutils.prerenderClientWithPhases)(()=>_workunitasyncstorageexternal.workUnitAsyncStorage.run(finalClientPrerenderStore, prerender, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
                ...
                onError: (err, errorInfo)=>{
                    ...
                    if ((0, _dynamicrendering.isPrerenderInterruptedError)(err) || finalClientController.signal.aborted) {
                        ...
                        if (typeof componentStack === 'string') {
                            (0, _dynamicrendering.trackAllowedDynamicAccess)(route, componentStack, dynamicValidation);
                        }
                        return;
                    }
                    return (0, _createerrorhandler.getDigestForWellKnownError)(err);
        ...
        preludeIsEmpty = (await (0, _apprenderprerenderutils.processPrelude)(unprocessedPrelude)).preludeIsEmpty;
    } catch (err) {
        rootDidError = true;
        preludeIsEmpty = true;
        if ((0, _dynamicrendering.isPrerenderInterruptedError)(err) || finalClientController.signal.aborted) {
    ...
    function LogDynamicValidation() {
        try {
            ...
            (0, _dynamicrendering.throwIfDisallowedDynamic)(route, preludeIsEmpty, dynamicValidation, serverDynamicTracking, clientDynamicTracking);
        } catch  {}
        return null;
    }
    ...
    try {
         ...
         */ // Prerender controller represents the lifetime of the prerender.
                ...
                if (!ctx.renderOpts.doNotThrowOnEmptyStaticShell) {
                    (0, _dynamicrendering.throwIfDisallowedDynamic)(workStore.route, preludeIsEmpty, dynamicValidation, serverDynamicTracking, clientDynamicTracking);
                }
                const getServerInsertedHTML = (0, _makegetserverinsertedhtml.makeGetServerInsertedHTML)({
                    polyfills,
                    renderServerInsertedHTML,
         ...
         */ const cache = workStore.incrementalCache;
                ...
                try {
                    ...
                    const processed = await (0, _apprenderprerenderutils.processPrelude)(result.prelude);
