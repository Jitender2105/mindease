        ...
        if (isRspack) {
            ...
            compiler.hooks.emit.tap(PLUGIN_NAME, (compilation)=>{
                Object.keys(compilation.assets).forEach((assetKey)=>{
                    var _asset__value_includes, _asset__value;
                    const asset = compilation.assets[assetKey];
                    if (asset == null ? void 0 : (_asset__value = asset._value) == null ? void 0 : (_asset__value_includes = _asset__value.includes) == null ? void 0 : _asset__value_includes.call(_asset__value, STRING_LITERAL_DROP_BUNDLE)) {
