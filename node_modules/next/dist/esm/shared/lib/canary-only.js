export function isStableBuild() {
    ...
    return !((_process_env___NEXT_VERSION = "15.4.0-canary.15") == null ? void 0 : _process_env___NEXT_VERSION.includes('canary')) && !process.env.__NEXT_TEST_MODE && !process.env.NEXT_PRIVATE_LOCAL_DEV;
}
