...
async function exportPageImpl(input, fileWriter) {
    ...
    _isProspectiveRender: isProspectiveRender = false, // Configure the rendering of the page not to throw if an empty static shell
    // is generated while rendering using PPR.
    _doNotThrowOnEmptyStaticShell: doNotThrowOnEmptyStaticShell = false, // Pull the original query out.
